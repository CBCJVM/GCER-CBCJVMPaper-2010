...
\author{Braden McDorman \textit{(beta/catron)}, Benjamin Woodruff \textit{(pipeep)}, Akshay Joshi \textit{(axyjo)}, Jonathan Frias \textit{(freakinjonathan)}}
\authorInfo{Norman High School \texttt{braden@betabot.org}, Fletcher High School \texttt{odetopi.e@gmail.com}, Unknown School in Qatar \texttt{me@akshayjoshi.com}, Robert E.~Lee High \texttt{freakinjonathan@gmail.com}}
