...
\title{\textbf{CBCJVM}\\Applications of the Java Virtual Machine with Robotics}
\author{Braden McDorman \texttt{(beta or catron, braden@betabot.org)}\\
Benjamin Woodruff \texttt{(pipeep, odetopi.e@gmail.com)}\\
Akshay Joshi \texttt{(axyjo, me@akshayjoshi.com)}\\
Jonathan Frias \texttt{(freakinjonathan, freakinjonathan@gmail.com)}}
